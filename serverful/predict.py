...
def predict_endpoint(img_bytes):
    """
    Predict the class of an image using ResNet18.
    """
    ...
    # Convert the predicted class index into a readable class label
    # Assuming you have a dictionary `class_idx_to_label` mapping indices to labels
    # predicted_class = class_idx_to_label[predicted.item()]
...
#     api_endpoint: str = "us-central1-a-aiplatform.googleapis.com",
# ):
#     endpoint = Endpoint(
